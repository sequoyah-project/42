...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("SQY://"))
    {
        uri.replace(0, 10, "SQY:");
    }
...
void openConfigfile()
{
    ...
    /* Open SQY.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "SQY.lnk";
}
...
{
    return GetAutostartDir() / "SQY.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("SQY-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  SQY-qt [" + tr("command-line options") + "]                     " + "\n";
